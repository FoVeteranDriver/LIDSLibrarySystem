...
export default {
    ...
    computed: {
        title () {
            return this.$store.state.appAdmin.currentTitle;
        },
        tagsList () {
            return this.$store.state.appAdmin.pageOpenedList;
        }
    },
    methods: {
        itemTitle (item) {
        ...
        closePage (event, name) {
            let pageOpenedList = this.$store.state.appAdmin.pageOpenedList;
            ...
            pageOpenedList = this.$store.state.appAdmin.pageOpenedList;
