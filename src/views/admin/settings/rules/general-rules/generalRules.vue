...
<template>
    <div class="rules-main">
        ...
        <Button type="ghost" class="open-rules" @click="addOpenRule">开放规则</Button>
        <Button type="ghost" class="close-rules" @click="addCloseRule">不开放规则</Button>
